...
const NavBar = () => {
    ...
    return (
        <div className='bg-teal-800'>
            <div className="navbar bg-teal-800 mx-auto container text-teal-200">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul tabIndex={0} className="menu menu-compact dropdown-content mt-3 p-2 shadow bg-base-100 rounded-box w-52">
                            <li className='bg-teal-900'><Link to={'/'}>Home</Link></li>
                            <li className='bg-teal-900'><Link to={'/all-toys'}>All Toys</Link></li>
                            {
                                user && <>
                                    <li className='bg-teal-900'><Link to={'/my-toys'}>My Toys</Link></li>
                                    <li className='bg-teal-900'><Link to={'/add-toy'}>Add a Toy</Link></li>
                                </>
                            }
                            <li className='bg-teal-900'><Link to={'/blogs'}>Blogs</Link></li>
                        </ul>
                    </div>
