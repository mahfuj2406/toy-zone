        ...
        <div className='container mb-5 rounded'>
            ...
            <div className="hero w-full bg-slate-200">
                <div className="hero-content w-full p-8">
                    ...
                    <div className='m-3'>
                        <h1 className="text-3xl font-bold text-slate-700 mb-8">Always remain upto-date aobut <span className='text-yellow-500 '>ToyZone</span></h1>
                        <div className='mt-3'>
                            <input className=' p-3 rounded-lg bg-slate-300 me-3 outline' type="email" placeholder='enter your email' />
